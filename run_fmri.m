...
DrawFormattedText(myscreen, 'The experiment will start soon!','center','center',[255 255 255 255]);        

Screen('Flip',myscreen);
HideCursor;
slack= 0.0078; % 1/60/2; % CHANGE: check this  0.0078 - maybe take out (should be +, I think)
my_drawfixation(myscreen,center_screen,15,15,[255 255 255]);  % prepare fixation
